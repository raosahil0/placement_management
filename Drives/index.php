		...
		<div class="specialty">
			...
			<div class="container">
				<div class="col-md-5 specialty-info wow fadeInLeft animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					...
					<p>To provide Knowledge with Academic Excellence and to make our Students better Technocrats & Professionals, 
						so that they chart out their own path of Success and possess Perfection in their endeavors.
						<span></span>
					</p>
		...
		<div class="testimonials">
			<div class="container">
				<div class="testimonial-nfo wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Our Motto</h3>
					<h5>We Just Learn with you and we give u a Platform to Improve Yourself</span>
					</h5>
				</div>
