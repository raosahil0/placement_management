...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, Mi,poco,LG, SonyErricsson, Motorola web design" />
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						<li class="hvr-sweep-to-bottom">
								<a href="../Homepage/index.php">GPCN<i>Goto Placement Homepage</i></a>
							</li>
						<li class="hvr-sweep-to-bottom">
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
					  <h3>Placement and Training Department</h3>
						<h5></span></h5>
						<p>Neemrana is emerging as little Japan, with the presence of Industry majors like Daikin, Nissin Brake, Toyoda Gosei, &amp; Mitsui, who have already set up sate-of-the-art and huge manufacturing facilities.International &amp; National industry giants including Parle Biscuits, Hero Motocorp, Terry-Plus India, Liberty whiteware, Havells, Tops and Rochee Breweries are running successfully along with other industries in Neemrana within the RIICO Zone.Neemrana is a city of immense potential given the fact that Investors, National industries, Japanese companies and such educational institutions are making a beeline to this ancient city to redefine it as the global city.
						</p>
					</div>
			...
			<div class="banner-bottom-grids a-banner-bottom-grids">
				...
				<div class="col-md-7 a-banner-bottom-text">
					<div class="jumbotron banner-bottom-left wow fadeInLeft animated animated" data-wow-delay="0.5s" style="visibility: visible; -webkit-animation-delay: 0.5s;">
						...
						<h5></span></h5>
						<p>Neemrana is an ancient historical town in Rajasthan, India. It is the site of 14th Century Hill-Fort which was ruled by Chauhans till 1947. The erstwhile ruling family, considered to be the direct lineage of Prithvirj Chauhan, being unable to maintain the fort after abolition of privy purses sold the fort to the group, Neemrana Hotels, that has converted it into a heritage hotel. The fort Sited atop the rare, dark Hornstone Breccia rocks, commands splendid agrarian views from its ramparts, which rise to 50-65 meters.  
						</p>
					</div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					...
					<div class="address">
						<p>KUNDANSINGH PURA
							<span>TEH. Neemrana Dist. Alwar</span>
						</p>
					</div>
					<div class="phone">
						<p>+91 8949516215</p>
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Govt. polytechnic collage</h6>
					<h4>
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Copyright &copy; 2023 GPCN| Developed by
              <a href="https://cheerful-biscuit-34d3ff.netlify.app/" target="_parent">sahilyadav</a>
				</div>
