        ...
        <nav id="mainNav" class="navbar navbar-default navbar-fixed-top" style="background:black">
            <div class="container-fluid">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand page-scroll" href="https://hte.rajasthan.gov.in/college/gpcneemrana/elfaculty-php">Govt. Polytechnic College</a>
                </div>
        ...
        <div class="footer">
			<div class="container">
				...
				<div class="col-md-3 get_in_touch ftr">
					<h3>GET IN TOUCH</h3>
					<p></p>
					<p>VILLAGE KUNDANSINGH PURA TEH. Neemrana Dist. Alwar, India</p>
					<p>8949516215</p>
					<a href="mailto:neemranagpc@gmail.com">Neemranagpc@gmail.com</a>
				</div>
